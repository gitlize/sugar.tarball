...
public class OldEncoder {
	...
	public static String PRAGMA_DOMINATING = "d";
    ...
    public void writePragma(String pragma) throws IOException {
        write("c " + SugarConstants.PRAGMA + " " + pragma + "\n");
    }
    ...
    public void encode(String satFileName, boolean incremental) throws SugarException, IOException {
        ...
        if (true) {
            ...
            for (IntegerVariable v : csp.getIntegerVariables()) {
                ...
                if (code0 < code1)
                    writePragma(PRAGMA_DOMINATING + " " + code0 + " " + code1);
            }
            code0 = code1 = 0;
            for (BooleanVariable v : csp.getBooleanVariables()) {
                if (! v.isDominant())
